...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(firebaseAuth.getCurrentUser() != null) {
                    Intent i = new Intent(MainActivity.this, AccessAccount.class);
        ...
        mGoogleApiC = new GoogleApiClient.Builder(getApplicationContext())
                            .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                                @Override
                                public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {

                                    Toast.makeText(MainActivity.this, "Error Google Api Client", Toast.LENGTH_SHORT).show();
    ...
    private void sigIn(){
        Intent i = Auth.GoogleSignInApi.getSignInIntent(mGoogleApiC);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d(TAG, "User: " + user.getEmail() + " " + user.getDisplayName() );
                           // updateUI(user);
                           // startActivity(new Intent(MainActivity.this, AccessAccount.class ));
                        } else {
